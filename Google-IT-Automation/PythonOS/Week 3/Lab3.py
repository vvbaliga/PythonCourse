...
def main():
  ...
  csv_file_location = '$path(enterpath of your file)/user_emails.csv'
  report_file = '$path(enter the path of your file where you want to drop output)' + '/updated_user_emails.csv'
  user_email_list = []
